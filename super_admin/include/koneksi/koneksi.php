...
// $db_username1 = "root";
// $db_password1 = "";
// $database1    = "databases_2025_stezze_manajemen_hotel";

// // Settingan koneksi 2
// $db_server2   = "localhost";
// $db_username2 = "ridikc";
// $db_password2 = "ridikc";
// $database2    = "databases_2025_steze_manajemen_hotel";

// Variabel utama (kosong dulu)
$db_server   = "localhost";
$db_username = "ridikcco_steze_hotel";
$db_password = "steze#hotel";
...
$koneksi = mysql_connect($db_server1, $db_username1, $db_password1);
if ($koneksi && mysql_select_db($database1, $koneksi)) {
