<div style="display: flex; justify-content: flex-end; margin-top: -59px; gap: 8px;">
    <!-- <a href="index.php?input=tambah" class="btn btn-sm btn-secondary fw-semibold">
        <i class='fas fa-add text-black'></i> Input Pengelola
    </a> -->
            ...
            <div style="overflow-x:auto;">
                <table <?php tabel(100, '%', 1, 'left'); ?>>
                    <tr style="background-color: #f9f9f9;">
                        ...
                        <th></th>
                        <!--h <th>Id Admin </th> h-->
                        <th align="left" class="th_border cell">Nama Pengelola</th>
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                            ...
                            $querypagination = "SELECT COUNT(*) AS total FROM data_pengelola";
                        }
                        ...
                        ?>
                            <tr class="event2">
                                ...
                                <td align="center" width="50"><?php $no = (($no + 1));
                                                                echo $no; ?></td>
                                <!--h <td align="left"><?php echo $data['id_pengelola']; ?></td> h-->
                                <td align="left">

                                    <a href="<?php index(); ?>?input=edit&proses=<?= encrypt($data['id_pengelola']); ?>" class='mx-2'>
