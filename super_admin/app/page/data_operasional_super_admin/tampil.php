                            ...
                            <tr class="event2">
                                ...
                                <!-- <td class="th_border cell" align="left" width="200">
                                    <table border="0">
                                        <tr>
                                            <td>
                                                <a href="<?php index(); ?>?input=detail&proses=<?= encrypt($data['id_operasional']); ?>" class='mx-2'>
                                            ...
                                            <td>
                                                <a href="<?php index(); ?>?input=hapus&proses=<?= encrypt($data['id_operasional']); ?>" class='mx-2'>
                                ...
                                <!--h <td align="left"><?php echo $data['id_operasional']; ?></td> h-->
                                <td align="left">
