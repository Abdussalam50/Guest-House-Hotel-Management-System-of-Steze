            ...
            <div style="overflow-x:auto;">
                <table <?php tabel(100, '%', 1, 'left'); ?>>
                    <tr>
                        ...
                        <th>No</th>
                        <th align="center" class="th_border cell">Id Bank </th>
                        ...
                        ?>
                            <tr class="event2">
                                ...
                                <td align="center" width="50"><?php $no = (($no + 1));
                                                                echo $no; ?></td>
                                <td align="center"><a href="<?php index();?>?input=edit&proses=<?php echo encrypt($data['id_bank']); ?>"> <?php echo $data['id_bank']?></a></td> 
                                <td align="center"><?php echo ucwords($data['nama_bank']); ?></td>
                               
                                <td align="center"><?php echo $data['rekening']; ?></td>
                                <td align="center"><?php echo ucwords($data['atas_nama']); ?></td>
