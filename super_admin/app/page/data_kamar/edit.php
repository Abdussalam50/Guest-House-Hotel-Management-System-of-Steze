                    ...
                    <input type="hidden" class="form-control" name="id_kamar" value="<?php echo $data['id_kamar']; ?>" readonly  id="id_kamar" required="required">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <option value="<?php echo ($data['id_tipe_kamar']); ?>">- <?php echo baca_database("","tipe_kamar","select * from data_tipe_kamar where id_tipe_kamar='$data[id_tipe_kamar]'"); ?> -</option><?php combo_database_v2('data_tipe_kamar','id_tipe_kamar','tipe_kamar',''); ?>
                                </select>
                            </td>
                        </tr>
                          <tr>
