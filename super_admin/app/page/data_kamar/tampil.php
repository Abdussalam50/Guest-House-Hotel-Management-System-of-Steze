                ...
                <table <?php
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                            ...
                            $querytabel = "SELECT * FROM data_kamar where $berdasarkan like '%$isi%'  LIMIT $startRow ,$dataPerPage";
                            $querypagination = "SELECT COUNT(*) AS total FROM data_kamar where $berdasarkan like '%$isi%' ";
                        } else {
                            $querytabel = "SELECT * FROM data_kamar  LIMIT $startRow ,$dataPerPage";
                            $querypagination = "SELECT COUNT(*) AS total FROM data_kamar ";
                        }
