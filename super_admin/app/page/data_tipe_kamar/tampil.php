                ...
                <table <?php tabel(100, '%', 1, 'left'); ?>>
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                            ...
                            $querytabel = "SELECT * FROM data_tipe_kamar  LIMIT $startRow ,$dataPerPage";
                            ...
                            <tr class="event2">
                                ...
                                <!-- <td class="th_border cell" align="left" width="200">
                                    <table border="0">
                                        <tr>
                                            <td>
                                                <a href="<?php index(); ?>?input=detail&proses=<?= encrypt($data['id_tipe_kamar']); ?>" class='mx-2'>
                                            ...
                                            <td>
                                                <a href="<?php index(); ?>?input=hapus&proses=<?= encrypt($data['id_tipe_kamar']); ?>" class='mx-2'>
