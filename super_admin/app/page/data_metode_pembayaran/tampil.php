            ...
            <div style="overflow-x:auto;">
                <table <?php tabel(100, '%', 1, 'left'); ?>>
                    <tr>
                        ...
                        <!--h <th>Id Hotel </th> h-->
                        <th align="center" class="th_border cell">Bank </th>
                        <th align="center" class="th_border cell">Nama Hotel</th>
                        <th align="center" class="th_border cell">Metode Pembayaran </th>
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                            ...
                            $querytabel = "SELECT * FROM data_metode_pembayaran WHERE id_hotel = '$id_hotel' LIMIT $startRow ,$dataPerPage";
                        ...
                        ?>
                            <tr class="event2">
                                <td align="center" width="50"><?php $no = (($no + 1));
                                                                echo $no; ?></td>
                                <td align="center"><a href="<?php index()?>?input=detail&proses=<?php echo encrypt($data['id_metode_pembayaran']); ?>"><?php echo ucwords(baca_database("","nama_bank","select * from data_bank where id_bank='{$data['id_bank']}'")); ?></a></td>

                                <!--h <td align="center"><?php echo $data['id_metode_pembayaran']; ?></td> h-->
                                <td align="center"><?php echo baca_database("", "nama", "select * from data_hotel where id_hotel='{$data['id_hotel']}'"); ?></td>
                                <td align="center"><?php echo $data['metode_pembayaran']; ?></td>
