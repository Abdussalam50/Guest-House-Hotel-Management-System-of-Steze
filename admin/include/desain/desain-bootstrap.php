...
{
    echo "<button class='btn btn-danger' ><i class='fa fa-plus-square'></i> " . $namatombol . "</button>";
};

function btn_preview_laporan($namatombol)
{
    echo "<button class='btn btn-sm btn-secondary fw-semibold' name='preview'><i class='fa fa-paste'></i> " . $namatombol . "</button>";
};

function btn_export_laporan($namatombol)
{
    echo "<button class='btn btn-sm btn-secondary fw-semibold' name='export'><i class='fa fa-file'></i> " . $namatombol . "</button>";
};
...
{
    echo "<button class='btn btn-danger' ><i class='fa fa-refresh'></i> " . $namatombol . "</button>";
};

function btn_cari($namatombol)
{
    echo "<button class='btn btn-danger' ><i class='fa fa-search'></i> " . $namatombol . "</button>";
};
...
{
    echo "<button class='btn btn-danger btn-xs' ><i class='fa fa-edit'></i> " . $namatombol . "</button>";
};
...
{
    echo "<button class='btn btn-danger' ><i class='fa fa-check'></i>" . $namatombol . "</button>";
};
...
{
    echo "<button class='btn btn-sm btn-secondary fw-semibold' ><i class='fa fa-backward'></i>" . $namatombol . "</button>";
};

function btn_simpan($namatombol)
{
    echo "<button class='btn btn-danger' ><i class='fa fa-save'></i>" . $namatombol . "</button>";
};
