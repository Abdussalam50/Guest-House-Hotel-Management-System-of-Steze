...
if (isset($_GET['input'])) {
    ...
    proses_action_cetak("data_hotel");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_hotel where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_hotel where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                ...
                <tr class="event2">
                    <td align="center" width="50"><?php $no = $no + 1; echo $no; ?></td>
                        <!--h <td align="center"><?php echo $data["id_hotel"]; ?></td> h-->
                                                ...
                                                <td align="center"><a target="_blank" href="https://www.google.com/maps?q=<?php echo $data["koordinat"]; ?>"><?php echo $data["koordinat"]; ?></a></td>
