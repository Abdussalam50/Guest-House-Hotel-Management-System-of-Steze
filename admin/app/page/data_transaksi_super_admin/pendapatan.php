...
?>
    ...
    <table id='tableheader'>
        <tr>
            ...
            <td width='80%'>
                <center>
                    <h3 style='color:#E62600; font-size:20px;margin:0px'>SteZe</h3>
                </center>
                <center>
                    <h1>LAPORAN PENDAPATAN</h1>
                </center>
                <center>
                    <h4 style='padding:5px;background-color:#eaeaea'><?php
                                                                        if (isset($text)) {
                                                                            echo $text;
                                                                        } else {
                ...
                ?>
                    <br>
                    <center>
                        <p style="background-color:#eaeaea;padding:10px"><?php echo $alamat ?></p>
                    </center>
