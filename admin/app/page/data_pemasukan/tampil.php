        ...
        <table <?php tabel(100, "%", 1, "left"); ?>>
            <tr>
                ...
                <!--h <th>Id pemasukan</th> -->
                                ...
                                <th align="left" class="th_border cell">Jumlah bayar</th>
                                <th align="left" class="th_border cell">Metode</th>
                                <th align="left" class="th_border cell">Nama bank</th>
                                <th align="left" class="th_border cell">Rekening</th>
                                <th align="left" class="th_border cell">Atas nama</th>
                                <th align="left" class="th_border cell">Keterangan</th>
            ...
            <tbody>
                ...
                if (
                    ...
                    $querytabel = "SELECT * FROM data_pemasukan where $berdasarkan like '%$isi%'  LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_pemasukan where $berdasarkan like '%$isi%'";
                } else {
                    $querytabel = "SELECT * FROM data_pemasukan  LIMIT $startRow ,$dataPerPage";
                    $querypagination =
                        "SELECT COUNT(*) AS total FROM data_pemasukan";
                }
                ...
                while ($data = mysql_fetch_array($proses)) { ?>
                    <tr class="event2">
                        ...
                        <!--h <td align="center"><?php echo $data["id_pemasukan"]; ?></td> h-->
                                                ...
                                                <td align="left"><?php echo $data["jumlah_bayar"]; ?></td>
                                                <td align="left"><?php echo $data["metode"]; ?></td>
                                                <td align="left"><?php echo $data["nama_bank"]; ?></td>
                                                <td align="left"><?php echo $data["rekening"]; ?></td>
                                                <td align="left"><?php echo $data["atas_nama"]; ?></td>
                                                <td align="left"><?php echo readmore($data["keterangan"]); ?></td>
