            ...
            <div class="card">
                ...
                <body class="bg-light p-4">
                    <form action="proses_simpan.php" enctype="multipart/form-data" method="post" id='formini'>
                        ...
                        <input type="hidden" value="<?php echo id_otomatis("data_booking", "id_transaksi", "10"); ?>" name="id_transaksi" placeholder="Id Transaksi " id="id_transaksi" required="required">
