...
// bikin filter hotel
$filter_hotel_operasional = $id_hotel != "" ? "AND id_hotel = '$id_hotel'" : "";
$filter_hotel_transaksi   = $id_hotel != "" ? "AND t.id_hotel = '$id_hotel'" : "";
$filter_hotel_transaksi2  = $id_hotel != "" ? "AND id_hotel = '$id_hotel'" : "";

// Ambil distinct tahun dari data_operasional & data_transaksi
...
<body>
	...
	<!-- Transaction Chart -->
	<h6>Jumlah Transaksi Tahun <?php echo htmlspecialchars($selected_year); ?></h6>
	...
	<hr>
	<!-- Revenue Chart -->
	<h6>Pendapatan Tahun <?php echo htmlspecialchars($selected_year); ?></h6>
	<div class="chart-container">
	...
	<hr>
	<!-- Expense Chart -->
	<h6>Biaya Operasional Tahun <?php echo htmlspecialchars($selected_year); ?></h6>
	<div class="chart-container">
