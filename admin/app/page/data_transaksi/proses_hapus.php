...
$query_riwayat=mysql_query("INSERT INTO data_hapus_transaksi (id_hapus_transaksi,id_transaksi,id_pelanggan,id_kamar,waktu_checkin,waktu_checkout,no_rekening,harga,metode_transaksi,jumlah_dewasa,jumlah_anak_anak,discount,status_transaksi,tanggal,id_admin) 
VALUES ('$id_hapus_transaksi','$id_transaksi','$id_pelanggan','$id_kamar','$waktu_checkin','$waktu_check_out','$no_rekening','$harga','$metode_transaksi','$jumlah_dewasa','$jumlah_anak_anak','$discount','$status_transaksi','$tanggal','$admin')") or die(mysql_error());
if($query_riwayat){
