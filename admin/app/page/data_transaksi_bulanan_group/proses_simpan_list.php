...
VALUES ('$id_list','$id_transaksi','$waktu','{$row['id_kamar']}','{$row['no_kamar']}','$jumlah_dewasa','$jumlah_anak_anak','$harga_kamar_harian','$harga_kamar_bulanan','$total_harga_kamar','$jumlah_bulan','bulanan')";
