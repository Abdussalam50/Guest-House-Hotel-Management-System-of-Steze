...
$id_kamar=baca_database("","id_kamar","select * from data_transaksi where id_transaksi='$proses'");
$id_deposit=baca_database("","id_deposit","select * from data_transaksi where id_transaksi='$proses'");
...
$query_transaksi="DELETE FROM data_transaksi WHERE id_transaksi='$proses'";
if($id_pajak!=='-'){
...
simpan_riwayat("data_transaksi","id_transaksi",$proses,$query_transaksi,$admin);
if($id_pajak!=='-'){
...
$query_delete  = mysql_query("DELETE FROM data_transaksi WHERE id_transaksi='$proses'");
