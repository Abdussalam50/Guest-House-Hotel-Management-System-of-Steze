                                                                            ...
                                                                            <div class="card kamar-card p-2 pilih-kamar-item"
                                                                                ...
                                                                                <div class="mt-auto" style="margin-bottom: 10px;">
                                                                                    <div class="text-left small mb-2">
                                                                                        ...
                                                                                        <br>
                                                                                        <span class="text-dark"><?= rupiah($kamar['harga_bulanan']) ?> @ 1 Month</span>
                                                                                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const updateCheckoutDate = () => {
            ...
            const jumlahBulan = parseInt(elements.days.value) || 1; // jumlah_bulan = input bulan
        ...
        btnPlus.addEventListener('click', () => {
            inputbulan.value = parseInt(inputbulan.value) + 1;
            updateCheckoutDate();
        });

        btnMinus.addEventListener('click', () => {
            let current = parseInt(inputbulan.value);
            if (current > 1) {
                inputbulan.value = current - 1;
            }
            updateCheckoutDate();
        });
