                    ...
                    <tr>
                        ...
                        <td>
                            <select name="tahun" id="tahun" class="form-control">
                                <?php
                                $query = mysql_query("SELECT DISTINCT YEAR(waktu_transaksi) AS tahun FROM data_booking ORDER BY waktu_transaksi DESC");
            ...
            <table class="table-content" id='table-content'>
                ...
                <tbody>
                    ...
                    while ($data = mysql_fetch_array($result)) {
                        ...
                        $id_kamar = baca_database("", "id_kamar", "select * from data_booking where id_transaksi='$data[id_transaksi]'")
                    ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td><?= $data['id_transaksi'] ?></td>
                            <td>Kamar <?= baca_database("", "no_kamar", "select * from data_booking where id_transaksi='$data[id_transaksi]'") ?></td>
