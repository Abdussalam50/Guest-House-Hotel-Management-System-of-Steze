            ...
            <div id="postcustom">
                <table class="table table-striped">
                    <tbody>
                        ...
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_booking", "id_transaksi", "10"); ?>" name="id_transaksi" placeholder="Id Transaksi " id="id_transaksi" required="required">
