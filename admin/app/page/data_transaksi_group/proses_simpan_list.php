...
$id_kamar         = mysql_real_escape_string($_POST['id_kamar']);
...
$q = "SELECT * FROM data_kamar WHERE id_kamar = '$id_kamar' LIMIT 1";
$r = mysql_query($q);
...
VALUES ('$id_list','$id_transaksi','$waktu','{$row['id_kamar']}','{$row['no_kamar']}','$jumlah_dewasa','$jumlah_anak_anak','$harga_kamar_harian','$harga_kamar_bulanan','$total_harga_kamar','$jumlah_hari','harian')";
