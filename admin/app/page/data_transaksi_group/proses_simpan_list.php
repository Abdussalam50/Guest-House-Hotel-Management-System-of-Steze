...
$jumlah_hari      = mysql_real_escape_string($_POST['jumlah_hari']);
...
$total_harga_kamar = $harga_kamar_harian * $jumlah_hari;

$insert = "INSERT INTO data_transaksi_list_kamar 
(id_transaksi_list_kamar, id_transaksi, waktu, id_kamar, no_kamar, jumlah_dewasa, jumlah_anak_anak, harga_kamar_harian,harga_kamar_bulanan, total_harga_kamar, jumlah_hari)
VALUES ('$id_list','$id_transaksi','$waktu','{$row['id_kamar']}','$no_kamar','$jumlah_dewasa','$jumlah_anak_anak','$harga_kamar_harian','$harga_kamar_bulanan','$total_harga_kamar','$jumlah_hari')";
