...
if (isset($_GET['input'])) {
    ...
    proses_action_cetak("data_tipe_kamar");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Tipe Kamar </th> h-->
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_tipe_kamar where $Berdasarkan like '%$isi%' AND id_hotel='$id_hotel' ";
                ...
                $querytabel = "SELECT * FROM data_tipe_kamar where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2') AND id_hotel='$id_hotel'";
            } else {
                //SEMUA
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <!--h <td align="center"><?php echo $data['id_tipe_kamar']; ?></td> h-->
