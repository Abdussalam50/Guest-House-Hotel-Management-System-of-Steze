...
$keterangan = 'Pembayaran Checkin Bulanan A.n ' . $nama_pelanggan . ', Kamar Nomor ' . $nomor_kamar . ' (' . ($tipe_kamar) . ")";
...
if ($query_transaksi && $query_pajak && $query_pemasukan && $query_deposit && $query_status) {
  ...
  ?>
    <script>
      window.location.href = "../checkout/notaA4-bulanan.php?id_trx=<?php echo $id_transaksi ?>&status=checkin";
    </script>
  <?php
  } else {
  ?>
