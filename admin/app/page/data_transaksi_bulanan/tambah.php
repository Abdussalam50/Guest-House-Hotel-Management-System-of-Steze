                                        ...
                                        <div class="cardcheckin h-100">
                                            <div class="cardcheckin-body">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="harga_bulan" readonly value="<?php echo rupiah_format($harga_bulanan); ?>">
                                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Sekarang berdasarkan jumlah bulan
        const calculateBasePrice = (months) => {
            return months * MONTHLY_RATE; // Langsung pakai harga bulanan
        };
        ...
        const updateCheckoutDate = () => {
            ...
            const months = parseInt(elements.days.value) || 0;

            if (!checkinDate || months <= 0) {
                elements.checkout.value = '';
                elements.harga_kamar.value = 0;
                updateFinalPrice();
                return;
            }

            // Hitung checkout: tambah bulan
            const checkoutDate = new Date(checkinDate);
            checkoutDate.setMonth(checkinDate.getMonth() + months);

            elements.checkout.value = checkoutDate.toISOString().split('T')[0];
            elements.months.value = months;

            // Hitung total: harga_bulanan × jumlah_bulan
            elements.harga_kamar.value = calculateBasePrice(months);
        ...
        elements.checkout.addEventListener('change', updateCheckoutDate);
