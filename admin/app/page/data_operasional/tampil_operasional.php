							...
							<div class="mt-auto">
								...
								<div class="stat-row mb-2">
									...
									<strong><?php echo baca_database("", "jumlah", "SELECT 
                                                                                        COUNT(*) AS jumlah
                                                                                    FROM 
                                                                                        data_transaksi where id_hotel='$idHotel'
                                                                                    
                                                                                    ") ?> Transaksi</strong>
								</div> -->

								<div class="stat-row mb-2">
									<strong><i class="fas fa-cogs text-danger  me-1"></i>Total Operasional</strong>
									<strong><?php echo rupiah($biaya['total']) ?></strong>
								</div>
