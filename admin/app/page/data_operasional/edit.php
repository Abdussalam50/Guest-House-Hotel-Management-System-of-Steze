                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>
                    ...
                    h-->
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input class="form-control" style="width:50%" type="datetime-local" name="tanggal" id="tanggal" placeholder="tanggal " required="required" value="<?php echo ($data['tanggal']); ?>">
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" class="leftrowcms">
                        ...
                        <tr>
                            <td width="25%" class="leftrowcms">
                                <label>Keperluan <span class="highlight"></span></label>
                            </td>
                            <td width="2%">:</td>
                            <td>
                                <textarea name="keperluan" id="keperluan" class='form-control' style='width:50%'><?php echo $data['keperluan'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" class="leftrowcms">
