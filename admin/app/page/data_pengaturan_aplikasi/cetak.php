...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_pengaturan_aplikasi");
} else {
    ...
    proses_action_cetak("data_pengaturan_aplikasi");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <center>
        <strong>LAPORAN
            ...
            <?php
            $tabelnya = "data_pengaturan_aplikasi";
    ...
    <table width="100%"  class="tblcms2">
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_pengaturan_aplikasi where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_pengaturan_aplikasi where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                ...
                <tr class="event2">
                    <td align="center" width="50"><?php $no = $no + 1; echo $no; ?></td>
                        <!--h <td align="center"><?php echo $data["id_pengaturan_aplikasi"]; ?></td> h-->
                                                <td align="left"><?php echo $data["nama_pengaturan"]; ?></td>
