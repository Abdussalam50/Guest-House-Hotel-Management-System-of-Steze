                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control selectpicker" name="data" id="data">
                                                <?php $query = mysql_query("SELECT nama_tabel FROM data_riwayat_superadmin GROUP BY nama_tabel");
                                                while ($data = mysql_fetch_array($query)) {
                                                ?>
                                                    <option value="<?= htmlspecialchars($data['nama_tabel']) ?>"><?= htmlspecialchars($data['nama_tabel']) ?></option>
                                                <?php
                                                }
                                                ?>
