...
if (isset($_GET['input'])) {
    ...
    <?php
    action_cetak("data_metode_pembayaran");
} else {
    ...
    proses_action_cetak("data_metode_pembayaran");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <center>
        <strong>LAPORAN
            ...
            <?php
            $tabelnya = "data_metode_pembayaran";
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Hotel </th> h-->
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_metode_pembayaran where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_metode_pembayaran where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
