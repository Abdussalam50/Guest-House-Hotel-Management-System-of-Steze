...
<div class="col-sm-12" style="margin-bottom: 20px; margin-top: 20px;">
    <div class="alert alert-warning">
        ...
        <strong>Edit Data Metode Pembayaran </strong>
        <hr class="message-inner-separator">
        <p>Silahkan Update Data Metode Pembayaran dibawah ini.</p>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group" style='width:50%'>
                                    <input type="hidden" name='id_bank' id='id_bank' style='width:50%' value='<?= $data['id_bank']?>' required='required'>
                                    <input type="varchar" name='nama_bank' id='nama_bank' style='width:50%' class="form-control" value='<?php
                                    $id_bank=$data['bank'];
                                    echo baca_database("","nama_bank","select * from data_bank where id_bank='$id_bank'")
                                    ?>'required='required'>
