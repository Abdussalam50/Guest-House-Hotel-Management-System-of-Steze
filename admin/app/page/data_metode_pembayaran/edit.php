                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>	
                    ...
                    <input type="hidden" class="form-control" name="id_metode_pembayaran" value="<?php echo $data['id_metode_pembayaran']; ?>" readonly  id="id_metode_pembayaran" required="required">
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input type='varchar' name="metode_pembayaran" id="metode_pembayaran" class="form-control" style='width:50%' placeholder="Metode Pembayaran" value="<?php $data['metode_pembayaran']?>" required>
