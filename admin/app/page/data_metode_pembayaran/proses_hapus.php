...
$sql="delete from data_metode_pembayaran where id_metode_pembayaran='$proses'";
simpan_riwayat("data_metode_pembayaran","id_metode_pembayaran",$proses,$sql,$id_handler);
$query=mysql_query("delete from data_metode_pembayaran where id_metode_pembayaran='$proses'");
if($query){
?>
