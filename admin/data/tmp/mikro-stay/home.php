    ...
    margin-top: -35px;">
			<div class="container-fluid my-3" style="box-shadow: 0 4px 8px rgb(47 47 47 / 30%);border-radius: 10px;height: 53px;padding-top: 7px;background-color: #ffffff; overflow-x:scroll">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<!-- <div class="navbar-scroll-wrapper w-100">
						<ul class="navbar-nav d-flex flex-row flex-nowrap me-auto mb-2 mb-lg-0">
														...
														?>
																	<div class="card card-flush flex-row-fluid p-8 pb-5 mw-100 card" style="--bs-card-box-shadow: 0px 0px 20px 0px rgb(72 85 127 / 55%); cursor: pointer; background-position: right top; background-size: 30%; background-repeat: no-repeat; background-image: url(&quot;../../../upload/1747180187-26415-1698105518-17748-abstract-1.svg&quot;); visibility: visible;">
																		<div class="card-body text-center" style="width: 150px; position: relative; color: rgb(255, 255, 255);">
																			<div class="mb-2">
																				<div class="text-left">
																					<span class="fw-bold text-gray-800 cursor-pointer text-hover-<?php echo $color_type; ?> fs-3 fs-xl-1" style="text-align: left;"> Kamar <?php echo $dataKamar['no_kamar'] ?></span>
																...
																?>
																	<div class="card card-flush flex-row-fluid p-8 pb-5 mw-100 card <?php echo $data_kamar['status_kamar'] == 'Kosong' ? 'bg-white' : 'bg-' . $color_type . '' ?>" style="--bs-card-box-shadow: 0px 0px 20px 0px rgb(72 85 127 / 55%); cursor: pointer; background-position: right top; background-size: 30%; background-repeat: no-repeat; background-image: url(&quot;../../../upload/1747180187-26415-1698105518-17748-abstract-1.svg&quot;); visibility: visible;">
																		<div class="card-body text-center" style="width: 150px; position: relative; color: rgb(255, 255, 255);">
																			<div class="mb-2">
																				<div class="text-left">
																					<span class="fw-bold text-gray-800 cursor-pointer text-hover-<?php echo $color_type; ?> fs-3 fs-xl-1" style="text-align: left;">Kamar <?php echo $data_kamar['no_kamar'] ?></span>
	...
	<!-- Tombol yang muncul di samping -->
	<button onclick="showHotelModal()" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-trigger="hover"
		class="explore-toggle btn btn-sm bg-body btn-color-gray-700 btn-active-danger shadow-sm position-fixed px-5 fw-bolder zindex-2 top-50 mt-10 end-0 transform-90 fs-6 rounded-top-0">


		<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Substract.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row g-3">
						...
						$queryHotel = mysql_query("SELECT * FROM data_hotel ORDER BY id_hotel = '$idhotel_cookie' DESC, nama ASC");
                ...
                WHERE id_hotel = '$idHotel'");
							...
							$queryPendapatan = mysql_query("SELECT  SUM(harga+biaya_tambahan_checkin+biaya_tambahan_checkout) as pendapatan FROM data_transaksi WHERE id_hotel='$idHotel' AND (
													MONTH(waktu_checkin) = MONTH(CURRENT_DATE())
													AND YEAR(waktu_checkin) = YEAR(CURRENT_DATE())
													OR
													MONTH(waktu_checkout) = MONTH(CURRENT_DATE())
													AND YEAR(waktu_checkout) = YEAR(CURRENT_DATE())
												)");
								...
								<div onclick="window.location.href = 'index.php?hotel=<?php echo encrypt($idHotel) ?>'"
									...
									<div class="card-body p-3 d-flex flex-column">
										...
										<div class="mt-auto">
											...
											<!-- <div class="stat-row mb-2">
												<strong><i class="fas fa-dollar text-success me-1"></i> Pendapatan</strong>
												<strong><?php echo rupiah($pendapatan['pendapatan']) ?></strong>
											</div>
											<div class="stat-row mb-2">
												<strong><i class="fas fa-dollar text-danger me-1"></i> Operasional</strong>
