                        ...
                        <div id="kt_app_sidebar_nav_wrapper" class="d-flex flex-column hover-scroll-y pe-4 me-n4"
                            ...
                            <div class="d-flex mb-3 mb-lg-6">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 me-6">
                                    ...
                                    <!--begin::Label-->
                                    <div id="transaksi" class="fs-6 fw-bold text-black"> <?php echo $jumlahPelanggan ?>
                                        Pelanggan
                                    </div>
                                    <!--end::Label-->
                                </div>
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 ">
                                    ...
                                    ?>
                                    <!--begin::Label-->
                                    <div id="tersedia" class="fs-6 fw-bold text-black"> <?php echo $jumlahTransaksi ?>
                                        Transaksi
                                    </div>
                                    <!--end::Label-->
                                </div>
                                ...
                                <div class="row row-cols-3" data-kt-buttons="true"
                                    ...
                                    if (isset($_COOKIE['jenenge'])) {
                                        ...
                                        if (!isset($_COOKIE['customer_service'])) {
                                            ...
                                            $m = new SimpleXMLElement('../../../include/settings/cs.xml', null, true);
                                        }
                                            ...
                                            if ($i->t == 'm') {
                                                ...
                                                if ($idmenu == 'B') {
                                                    ...
                                                    if (!isset($_COOKIE['customer_service'])) {
                                                        ...
                                                        $m1 = new SimpleXMLElement('../../../include/settings/cs.xml', null, true);
                                                    }
